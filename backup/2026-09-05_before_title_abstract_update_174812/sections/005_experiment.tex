...
\subsection{Study 3: a focused PG versus top-k comparison}
...
At the same checkpoints, compare cumulative-delta sparsity, update
energy concentration, and, in the joint setting, teacher-conditioned
support overlap. Report actual step size and capability alongside
