...
## 3. PG vs top-k：简洁的单教师/多教师对照

先完成下表，不把噪声、MC 次数或 tail correction 的机制研究列为必做：
...
主稿标题已改为 Multi-Teacher On-Policy Distillation: Task Weighting and Sparse Parameter Updates。
