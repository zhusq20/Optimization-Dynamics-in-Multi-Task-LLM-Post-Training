...
3. Compare sampled-token PG and top-64 in single-teacher and multi-teacher OPD. Further noise or truncation analysis is conditional on a stable meaningful sparsity difference, not required by default.
