...
task. We derive how teacher log-ratio signals on retained tokens produce
the student's task gradients, then separate the mean update's direction
and rate from uncertainty due to finite sampling. An exact quadratic
example has no task conflict or sampling noise but unequal convergence
rates. For losses on
