> **31组局部机制数据现已重画为15张独立实验图。** [浏览独立图](../figures/local_probe_results_20260908/index.html)、[一图一页PDF](../figures/local_probe_results_20260908/all_panels.pdf)、[caption草稿](local_probe_results_20260908/FIGURE_CAPTIONS.md)、[现行路线图](EXPERIMENT_FIGURE_ROADMAP_20260908_zh.md)。F5–F7已合并checkpoint/loss，图内无标题和解释段落。新增交集训练和训练种子重复仍已取消。
