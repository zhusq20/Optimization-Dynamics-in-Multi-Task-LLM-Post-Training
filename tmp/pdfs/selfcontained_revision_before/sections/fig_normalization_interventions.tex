...
(c) Held-out reverse-KL changes (lower is better). Open points are batches; filled points and bars show means and standard deviations. SGD steps match the corresponding Adam step norm.}
