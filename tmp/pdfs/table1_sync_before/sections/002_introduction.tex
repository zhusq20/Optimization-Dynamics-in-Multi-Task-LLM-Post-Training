...
Domain-token and domain-response gradients have mean cosine 0.680, rising to 0.960 after applying the same Adam state. The three averaging rules finish within 0.14 mean-score points, although their learning curves differ.
...
Top-64 and full-vocabulary supervision yield similar single-step concentration. Against sampled-token supervision, top-64's joint-training mean advantage shrinks from 1.69 points at update 250 to 0.29 at update 500, with mixed per-task differences.
\end{enumerate}
