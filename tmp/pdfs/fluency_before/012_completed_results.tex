...
The minimum student probability mass in the actual student--teacher top-64 intersection is 96.55\% over the 384 sampled prefixes, and no intersection is empty (Table~\ref{tab:intersection_coverage}).
