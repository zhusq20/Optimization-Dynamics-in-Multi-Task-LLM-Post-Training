...
(a) Gradient cosine to full-vocabulary supervision, using 12 fixed prefix subsets with two independent sampling repetitions per budget; I64 uses the top-64 intersection.
