...
\caption{\textbf{task gains coexist with domain-level trade-offs.} Joint-training scores (\%); Mean weights domains equally. $\Delta$ is the mean difference from PG-DR/Adam (percentage points); brackets give estimated paired 95\% intervals.}
\label{tab:completed_endpoints}
\begin{tabular}{lrrrrrr}
\toprule
Configuration & MATH-500 & Code & IF & GPQA & Mean & $\Delta$ [95\% interval]$^{\dagger}$ \\
\midrule
