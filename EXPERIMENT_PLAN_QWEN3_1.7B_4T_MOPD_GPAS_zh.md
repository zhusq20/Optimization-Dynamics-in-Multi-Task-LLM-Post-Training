...
本次修改的是实验文档和实验目录说明；论文正文的范围同步与实测结果回填随实验交付完成。旧解析 teaser 与合成数据已移入项目外恢复归档，不作为四域实测结果。

旧 GPAS 理论与比较配方已移入项目外恢复归档。两周限制、单种子和四域 RL 教师设置仅适用于本历史方案；当前论文与实验规范以[三点贡献与实验主线](MOPD_THREE_CONTRIBUTIONS_2026-09-05_zh.md)为准。
