...
The three studies connect loss weighting, parameter-update concentration in a
...
cumulative parameter changes. A concentrated cumulative change need not imply that each gradient or
optimizer step was similarly concentrated. Overlapping update locations
can also contain either shared or opposing corrections.
...
differences may or may not predict which parameters change most. Capability measurements determine whether these optimization
