...
Qwen3-1.7B student (Appendix~\ref{app:setup}). Teacher training introduces another source of
...
Qwen3-1.7B. Thus $\mu_d$ specifies the reference in the teacher's
...
\end{equation}
When the student's initial policy differs from a teacher's RL
