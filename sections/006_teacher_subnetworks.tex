...
\noindent Figure~\ref{fig:subnetwork_overview}(b) supplies the completed same-state teacher-step comparison with common-input and routed-input controls. The existing raw-gradient matrix remains a separate diagnostic in Appendix~\ref{app:gradient_overlap}.
...
\noindent Figure~\ref{fig:subnetwork_overview}(c) pairs teacher JS with the completed common-input optimizer-step selections. The earlier gradient comparison remains in Appendix~\ref{app:teacher_distance}.
