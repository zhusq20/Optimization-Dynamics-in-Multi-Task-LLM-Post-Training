...
PG/I64 under DR in single-teacher (S) and joint (M) training: (a,b) nonzero fractions; (c,d) coordinate fractions containing 90\% of squared change. Lines connect measured updates 1, 50, 100, 250, and 500.}
\label{fig:geometry}
\end{figure}
